...
public class Player {
    ...
    public void play() throws GameException {
        ...
        // Special case for Queen and Ten cards - they can be played without marbles
        boolean isQueenOrTen = selectedCard.getName().contains("Queen") || selectedCard.getName().contains("Ten");
        
        // Only validate marble selection if not a Queen/Ten card being played without marbles
        if(!(isQueenOrTen && selectedMarbles.isEmpty())) {
